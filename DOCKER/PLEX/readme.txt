...
2/ créer un user et un groupe qui pourra accéder au dossier sur le serveur via le script Scritps/SHELL/user_&_group_add.sh
3/ Sur le serveur client, lancer le script Scripts/DOCKER/PLEX/plex_config.sh qui lancera les scripts suivants :
  Scritps/SHELL/user_&_group_add.sh pour créer le même user que sur le serveur
